...
const PLAID_CLIENT_ID = "5fa412a67d3a1e00139f9639";
const PLAID_SECRET = "0dd6a0960b6261ce0479fcdabf6e67";
...
// @access Privte
route.post('/accounts/add', passport.authenticate('jwt', { session: false }), (req, res) => {
